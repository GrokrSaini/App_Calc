    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                sh 'python -m py_compile sources/calculator.py sources/calculator_module.py'
        ...
        stage('Test') {
            ...
            steps {
                ...
                sh 'py.test --verbose --junit-xml test-reports/results.xml sources/testing_calculator.py'
            }
            post {
                always {
