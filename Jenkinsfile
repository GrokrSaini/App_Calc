    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                sh 'python -m py_compile App_Calc/calculator.py App_Calc/calculator_module.py'
                //This stash step saves the Python source code and compiled byte code files from the sources
                //workspace directory for use in later stages.
                stash(name: 'compiled-results', includes: 'App_Calc/*.py*')
            }
        }
        stage('Test') {
            agent {
            ...
            steps {
                ...
                sh 'py.test --verbose --junit-xml test-reports/results.xml App_Calc/testing_calculator.py'
            }
            post {
                always {
        ...
        stage('Deliver') {
                    ...
                    steps {
                        echo "This is where we deploy app"
                        }
